                ...
                <div class="dropdown float-right">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                      <a class="dropdown-item" href="#">
                        <div class="media">
                            <img class="align-self-center mr-3" src="https://pbs.twimg.com/profile_images/1622875823513669634/9_6ooCGA_400x400.jpg" width="50" height="60" alt="Generic placeholder image">
